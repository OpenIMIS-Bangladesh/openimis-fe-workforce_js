...
const BeneficiaryBankAdviceList = () => {
  ...
  console.log("hello from bank advice list", data);
  ...
  return (
    <Box bgcolor="#fafafa" minHeight="100vh">
                ...
                return (
                  <TableRow key={row.id} hover>
                    ...
                    <TableCell align="center">
                      ...
                      {!row?.isConfirmed ? (
                        <>
                          <Button variant="outlined" size="small" onClick={() => openApproveConfirm(row.id)} style={{ marginLeft: 6 }}>
                            Confirm Now
                          </Button>
                        </>
                      ) : (
      ...
      <Dialog open={confirmOpen} onClose={closeApproveConfirm}>
        ...
        <DialogContent>
          <Typography>Are you sure you want to Confirm the selected bank advice?</Typography>
        </DialogContent>
