...
const useStyles = makeStyles({
    ...
    '@media print': {
      ...
      '.print-button-container, .MuiIconButton-root': {
...
// --- PRINTABLE COMPONENT ---
const DeathApplicationPrintView = ({ printRef,data, documents, logoLeftUrl,logoLeft }) => {
    ...
    return (
        ...
        <div id="print-container"> 
            <Paper ref={printRef} id="print-container" className={`${classes.paper} printable-paper`}>
...
export default DeathApplicationPrintView