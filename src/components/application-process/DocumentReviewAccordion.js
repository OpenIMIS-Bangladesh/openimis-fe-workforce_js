...
const DocumentReviewAccordion = ({ file, index, documentId, onCommentChange, onVerify, onReject, locale, onFileChange, fromResend = false,viewedFromFlag }) => {
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Grid container spacing={2}>
            ...
            ].includes(user_type)) && viewedFromFlag && viewedFromFlag === "verify" && (
