...
import AddAccountInfoPage from "../../../pages/workforce-employee/account-info/AddAccountInfoPage";
      ...
      <>
        ...
        {(!!fetchedEmployeeAccident || !workforceEmployeeUuid) && (
          <Form
            ...
            readOnly={readOnly}
            overview={overview}
            Panels={workforceEmployeeUuid ? [EditAccountInfoPage] : [AddAccountInfoPage]}
