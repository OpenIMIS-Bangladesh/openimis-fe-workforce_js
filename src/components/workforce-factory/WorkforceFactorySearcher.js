...
class WorkforceFactorySearcher extends Component {
  ...
  fetch = (prms) => {
    ...
    if(this.props.association){
      prms.push(`allAssociationIdIn: [${this.props.association}]`);
    }
  ...
  headers = () => [
    ...
    "workforce.representative.phone",
  ...
  itemFormatters = () => {
    const formatters = [
      ...
      (workforcefactory) => workforcefactory.workforceRepresentative?.phoneNumber,
