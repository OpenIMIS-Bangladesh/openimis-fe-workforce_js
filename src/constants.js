...
export const WORKFORCE_STATUS = {
  ...
  PROPOSED_FOR_REJECTION:"proposed_for_rejection"
};
...
export const STATUS_MAP_BN  = {
  ...
  approved_by_doctor: "ডাক্তার দ্বারা সুপারিশকৃত",
  rejected: "বাতিলকৃত",
  ...
  proposed_for_rejection:"বাতিলের জন্য প্রস্তাবিত",
...
export const STATUS_MAP_EN = {
  ...
  proposed_for_rejection:"Proposed for Rejection",
...
export const WORKFORCE_DOCUMENT_STATUS = {
  ...
  SECTION_OFFICER_VERIFIED:"verified_by_data_entry_officer",
  ...
  SECTION_OFFICER_REJECTED:"rejected_by_data_entry_officer",
...
export const WORKFORCE_DOCUMENT_MAP_BN={
  ...
  rejected_by_dol_dife: "শ্রম অধিদপ্তর এবং কল-কারখানা ও প্রতিষ্ঠান পরিদর্শন অধিদপ্তর দ্বারা বাতিলকৃত",
}
...
export const cfStatusOptions = [
  ...
  { value: "approved_by_doctor", label: "ডাক্তার দ্বারা সুপারিশকৃত" },
...
export const banglaLabels = {
  ...
  FactoryMembershipNo: "কারখানার সদস্যপদ নং",
  FactoryRegistrationDate: "কারখানার নিবন্ধনের তারিখ",
  FactoryRegistrationExpiryDate: "কারখানার নিবন্ধনের মেয়াদ শেষ তারিখ",
