...
const Dashboard = () => {
  ...
  useEffect(() => {
    async function loadAdvisorAndDashboardRequirements() {
      // Dispatch actions to fetch new Advisor data and Financial Data here.
    }
    loadAdvisorAndDashboardRequirements();
