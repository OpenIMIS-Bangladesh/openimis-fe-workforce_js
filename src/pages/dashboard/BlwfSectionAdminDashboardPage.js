...
const RejectedApplications = ({ disableButtons = 0 }) => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchSummaryApplications(modulesManager, ['organizationType:"blwf"', 'statusIn:["forward_to_comiitee","forward_to_director","forward_to_dg","approved_by_dg","approved_by_committee"]','applicationStatusIn:["rejected_by_committee"]']));
