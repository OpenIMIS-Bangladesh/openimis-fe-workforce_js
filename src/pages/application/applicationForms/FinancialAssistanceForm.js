  ...
  useEffect(() => {
    if (employeeData) {
      ...
      setFormData({
        ...
        factory: formData?.employeeFactory?.id||employeeData.factory || formData?.workforceEmployee?.factory?.id || parsedApplicationData?.employeeFactory ||workforceFactoryId || null,
