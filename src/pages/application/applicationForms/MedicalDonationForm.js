...
import { getInfoId, getUserType, safeApplicationId } from "../../../utils/utils";
  ...
  const steps = [
    {
      ...
      content: <MedicalDonationCheckbox handleChange={(key, value) => handleChange(key, value, "metadata")} formData={formData} />,
    },
    {
