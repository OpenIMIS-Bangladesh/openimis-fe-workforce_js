...
import { getUserTypeFromRights, isEisPath, safeDecodeId, safeParse, tryParse } from "../../utils/utils";
        ...
        user_type === WORKFORCE_USER_TYPE.FACTORY_ADMIN
          ...
          : user_type === WORKFORCE_USER_TYPE.ASSOCIATION
            ...
            : user_type === WORKFORCE_USER_TYPE.EIS_OFFICER
              ...
              :user_type===WORKFORCE_USER_TYPE.BLWF_DOL_DIFE?WORKFORCE_DOCUMENT_STATUS.DOL_DIFE_VERIFIED:( WORKFORCE_USER_TYPE.CHECKER || WORKFORCE_USER_TYPE.CHECKER_TWO)?WORKFORCE_DOCUMENT_STATUS.SECTION_OFFICER_VERIFIED :
              "",
      note: file.note,
        ...
        user_type === WORKFORCE_USER_TYPE.FACTORY_ADMIN
          ...
          : user_type === WORKFORCE_USER_TYPE.ASSOCIATION
            ...
            : user_type === WORKFORCE_USER_TYPE.EIS_OFFICER
              ...
              :user_type===WORKFORCE_USER_TYPE.BLWF_DOL_DIFE?WORKFORCE_DOCUMENT_STATUS.DOL_DIFE_REJECTED: ( WORKFORCE_USER_TYPE.CHECKER || WORKFORCE_USER_TYPE.CHECKER_TWO)?WORKFORCE_DOCUMENT_STATUS.SECTION_OFFICER_REJECTED :
              "",
      note: file.note,
      verifierId: loggedInUserId,
      verificationDate: today,
