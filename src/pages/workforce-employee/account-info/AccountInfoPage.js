...
import AccountInfoForm from "../../../components/workforce-employee/account-info/AccountInfoForm";
...
class AccoutInfoPage extends Component {
  add = () => {
    ...
    return (
      <div className={`${readOnly ? classes.lockedPage : null} ${classes.page}`}>
        <AccountInfoForm
          ...
          readOnly={readOnly}
          back={() => historyPush(modulesManager, history, "workforce.route.employees.account.infos")}
...
export default withHistory(withModulesManager(connect(mapStateToProps, mapDispatchToProps)(
  withTheme(withStyles(styles)(AccoutInfoPage))),
));
